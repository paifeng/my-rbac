...
<script type="text/javascript">
	window.onload = function() {
		...
		//显示所有的用户信息
		commitRole("listrole", null);
		//添加用户
		var addUser = document.getElementById("add-user");
		addUser.onclick = function() {
			commitRole("addroleUI", null);
		};
	};

	//修改用户
	function commitRole(action, id) {
		OpenAjax("${ pageContext.request.contextPath }/servlet/RoleServlet",
	...
	function selectAll(obj) {
		var priviChks = document.getElementsByName("privilegeid");

		for (i = 0; i < priviChks.length; i++) {
			priviChks[i].checked = obj.checked;
		}
	}
</script>
...
<body>
	...
	<div class="main-usermanage-warp">
		<div class="usermanage-bar">
			<a class="bar-item" href="javascript:void(0);" id="add-user">新建角色</a>
		</div>
