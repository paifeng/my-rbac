...
<script type="text/javascript">
	window.onload = function() {
		...
		//显示所有的用户信息
		commitUser("listuser", null);
		//添加用户
		var addUser = document.getElementById("add-user");
		addUser.onclick = function() {
			commitUser("adduserUI", null);
		};
	};

	//修改用户
	function commitUser(action, id) {
		OpenAjax("${ pageContext.request.contextPath }/servlet/UserManageServlet",
...
<body>
	...
	<div class="main-usermanage-warp">
		<div class="usermanage-bar">
			<a class="bar-item" href="javascript:void(0);" id="add-user">添加用户</a>
		</div>
